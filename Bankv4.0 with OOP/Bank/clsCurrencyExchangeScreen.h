...
private:
    ...
    static void _ShowListCurrenciesScreen()
    {
        ...
        clsListCurrenciesScreen::ShowClientsList();
    }
    ...
    static void _PerformCurrencyExchangeMenueOption(enCurrencyExchangeMenueOption CurrencyExchangeMenueOption)
    {
        ...
        case enCurrencyExchangeMenueOption::eShowMainMenue:
        {
...
public:
    ...
    static void ShowCurrencyExchangeMenue()
    {
        ...
        _PerformCurrencyExchangeMenueOption((enCurrencyExchangeMenueOption)ReadCurrencyExchangeMenueOption());
    }
